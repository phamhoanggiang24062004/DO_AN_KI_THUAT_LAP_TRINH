...
void Print_1Class(New_Class x)
{
	...
	cout <<left<<setw(5)<<"|"<< left << setw(20) << x.Class_Name << left << setw(5) << "|" << left << setw(17) << x.type << left << setw(5) << "|" << left << setw(25) << x.Number_Student<<"|" << endl;
	cout << right << setw(2) << "-";
	for (int i = 1;i <= 75;i++)
	{
		cout << "-";
...
{
	cout << right << setw(47) << "DANH SACH LOP HOC" << endl;
	cout << right << setw(2) << "-";
	for (int i = 1;i <= 75;i++)
	{
		cout << "-";
	...
	cout << endl;
	cout <<left<<setw(5)<<"|"<< left << setw(20) << "Ten lop hoc" << left << setw(5) << "|" << left << setw(17) << "He dao tao" << left << setw(5) << "|" << left << setw(25) << "So luong sinh vien" << "|" << endl;
	cout << right << setw(2) << "-";
	for (int i = 1;i <= 75;i++)
	{
		cout << "-";
...
void Print_ListStudent_1Class(List_Class l,string Name)
{
	...
	for ( i = l.pHead;i != NULL;i = i->pNext)
	{
		if (_stricmp(i->info.Class_Name.c_str(), Name.c_str()) == 0)
		{
			...
			cout <<right<< setw(79) << "DANH SACH SINH VIEN" << endl;
