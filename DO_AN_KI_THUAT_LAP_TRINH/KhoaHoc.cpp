...
void Print_1Course(Course x)
{
    ...
    cout <<left<<setw(3)<<"|"<< left << setw(15) << x.ID <<left<<setw(3)<<"|"<< left << setw(20) << x.Course_Name << left << setw(3) << "|" << left << setw(16) << x.CLASS.Class_Name << left << setw(3) << "|" << left << setw(20) << x.CLASS.TEACHER.Teacher_Name << left << setw(3) << "|" << left << setw(13) << x.Credit_Number << left << setw(3) << "|" << left << setw(15) << x.Day << left << setw(3) << "|" << left << setw(12) << x.Session << left << setw(3) << "|" << left << setw(15) << x.CLASS.Number_Student << "|" << endl;
	cout << right << setw(2) << "-";
	for (int i = 1;i <= 148;i++)
	{
		cout << "-";
...
void Print_List_Course(List_Course l)
{
	...
	cout << right << setw(84) << "DANH SACH KHOA HOC" << endl;
	cout << right << setw(2) << "-";
	for (int i = 1;i <= 148;i++)
	{
		cout << "-";
	...
	cout << endl;
	cout <<left<<setw(3)<<"|"<< left << setw(15) << "ID khoa hoc" <<left<<setw(3)<<"|"<< left << setw(20) << "Ten khoa hoc" <<left<<setw(3)<<"|"<< left << setw(16) << "Ten lop hoc" <<left<<setw(3)<<"|"<< left << setw(20) << "Ten giang vien" <<left<<setw(3)<<"|"<< left << setw(13) << "So tin chi" <<left<<setw(3)<<"|"<< left << setw(15) << "Ngay hoc(Thu)" <<left<<setw(3)<<"|"<< left << setw(12) << "Buoi hoc" <<left<<setw(3)<<"|"<< left << setw(15) << "So sinh vien"<<"|" << endl;
	cout << right << setw(2) << "-";
	for (int i = 1;i <= 148;i++)
	{
		cout << "-";
...
void Print_ListCourse_1Student(List_Course l, string ID)
{
	...
	bool check = false;
	Node_Course* temp = l.pHead;
	cout << right << setw(77) << "DANH SACH KHOA HOC" << endl;
	cout << right << setw(2) << "-";
	for (int i = 1;i <= 133;i++)
	{
		cout << "-";
	...
	cout << endl;
	cout <<left<<setw(3)<<"|"<<left << setw(10) << "STT" << left << setw(3) << "|" << left << setw(12) << "ID" << left << setw(3) << "|" << left << setw(20) << "Ten khoa hoc" << left << setw(3) << "|" << left << setw(15) << "So tin chi" << left << setw(3) << "|" << left << setw(18) << "Ngay hoc(Thu)" << left << setw(3) << "|" << left << setw(15) << "Buoi hoc" << left << setw(3) << "|" << left << setw(24) << "So luong sinh vien" <<"|"<< endl;
	cout << right << setw(2) << "-";
	for (int i = 1;i <= 133;i++)
	{
		cout << "-";
	...
	while (temp != NULL)
	{
			...
			while (St != NULL)
			{
				...
				{
					cout <<left<<setw(3)<<"|"<< left << setw(10) << cnt <<left<<setw(3)<<"|"<< left << setw(12) << temp->info.ID << left << setw(3) << "|" << left << setw(20) << temp->info.Course_Name << left << setw(3) << "|" << left << setw(15) << temp->info.Credit_Number << left << setw(3) << "|" << left << setw(18) << temp->info.Day << left << setw(3) << "|" << left << setw(15) << temp->info.Session << left << setw(3) << "|" << left << setw(24) << temp->info.CLASS.Number_Student<<"|" << endl;
					cout << right << setw(2) << "-";
					for (int i = 1;i <= 133;i++)
					{
						cout << "-";
...
void Print_ListStudent_1Course(List_Course l,string ID)
{
	...
	while (c != NULL)
	{
		...
		{
			cout << right<<setw(87) << "DANH SACH SINH VIEN CUA KHOA HOC" << endl;
