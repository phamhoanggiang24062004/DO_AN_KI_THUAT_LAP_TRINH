...
void Print_1Course(Course x)
{
    ...
    cout << left<<setw(15)<<x.ID <<left<< setw(20) << x.Course_Name <<left<< setw(16) << x.CLASS.Class_Name<<left<<setw(20)<<x.CLASS.TEACHER.Teacher_Name<<left<<setw(20)<<x.Credit_Number<<left<<setw(18)<<x.Day<<left<<setw(15)<<x.Session <<left<<setw(24)<<x.CLASS.Number_Student<< endl;
...
void Print_List_Course(List_Course l)
{
	    ...
	    cout << left << setw(15) << "ID khoa hoc" << left << setw(20) << "Ten khoa hoc"<<left<<setw(16)<<"Ten lop hoc"<<left<<setw(20)<<"Ten giang vien" << left << setw(20) << "So tin chi" << left << setw(18) << "Ngay hoc(Thu)" << left << setw(15) << "Buoi hoc" <<left<<setw(24)<<"So luong sinh vien"<< endl;
		while (l.pHead != NULL)
		{
...
void Print_ListStudent_1Course(List_Course l,string ID)
{
	...
	while (c != NULL)
	{
		...
		{
			cout << setw(70) << "DANH SACH SINH VIEN CUA KHOA HOC:" << endl;
