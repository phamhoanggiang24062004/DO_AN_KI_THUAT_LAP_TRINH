...
void Print_1Student(Student x)
{
	...
	cout <<left<<setw(3)<<"|"<<left << setw(15) << x.No <<left<<setw(5)<<"|"<< left << setw(20) << x.StudentID <<left<<setw(5)<<"|"<< left << setw(25) << FullName <<left<<setw(5)<<"|"<< left << setw(15) << Day <<left<<setw(5)<<"|"<< left << setw(15) << x.Gender <<left<<setw(5)<<"|"<<left << setw(25) << x.SocialID<<"|" << endl;
	cout << right << setw(2) << "-";
	for (int i = 1;i <= 141;i++)
	{
		cout << "-";
...
void Print_List_Student(List_Student l)
{
	...
	cout << endl;
	cout <<left<<setw(3)<<"|"<< left << setw(15) << "So thu tu" <<left<<setw(5)<<"|"<< left << setw(20) << "Ma so sinh vien" <<left<<setw(5)<<"|"<< left << setw(25) << "Ho va ten" <<left<<setw(5)<<"|"<< left << setw(15) << "Ngay sinh" <<left<<setw(5)<<"|"<< left << setw(15) << "Gioi tinh" <<left<<setw(5)<<"|"<< left << setw(25) << "Can cuoc cong dan"<<"|" << endl;
	cout << right << setw(2) << "-";
	for (int i = 1;i <= 141;i++)
	{
		cout << "-";
