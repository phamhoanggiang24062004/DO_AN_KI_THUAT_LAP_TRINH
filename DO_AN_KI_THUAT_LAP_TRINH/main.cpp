	...
	while (true)
	{
		...
		if (choose == 1)
		{
			while (true)
			{
				...
				cout << "| 11. Doc bang diem sinh vien tu file csv.                     |" << endl;
				...
				else if (luachon == 15)
				{
					...
					while (temp != NULL)
					{
						if (temp->data.ID.compare(ID) == 0 && temp->data.pass.compare(old) == 0)
						{
		...
		else if (choose == 2)
		{
			while (true)
			{
				...
				else if (luachon == 4)
				{
					...
					while (temp != NULL)
					{
						if (temp->data.ID.compare(ID) == 0 && temp->data.pass.compare(old_pass) == 0)
						{
							cout << "Nhap mat khau moi: ";
							string new_pass;
							cin >> new_pass;
